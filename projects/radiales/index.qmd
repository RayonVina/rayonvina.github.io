...
links:
  - icon: link
    name: Project Page
    url: https://www.seriestemporales-ieo.net/
  - icon: link
    name: Gijón Port Authority
...
Due to the nature of the project, each oceanographic center generates an enormous amount of oceanographic data annually for multiple Essential Oceanographic Variables (EOVs). As part of the plan to improve the information gathered in the project, I designed and deployed the VGOHAdB database, to store all data produced by our research group.
